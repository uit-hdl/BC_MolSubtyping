...
# Convert the dataset to a PyTorch data loader
# data_loader = torch.utils.data.DataLoader(dataset, batch_size=64, shuffle=True)

# Apply the oversampling transformation
# oversampler = torchsample.Oversampler(sampler=torchsample.imbalanced.RandomOverSampler())
# oversampled_data_loader = oversampler(data_loader)

# Train your PyTorch model on the oversampled data
