...
# Breast_Cancer_Subtyping is a modified repository of MultiStainDeepLearning.
This is the GitHub Repository for the CNN-based classification of histopathology images. Although we did not use the idea of multi-modal input, we found the code very neat and used it for our paper based on our needs with minor modifications.
